...
> ggplot(df1, aes(x=year))+ geom_bar())
Error: unexpected ')' in "ggplot(df1, aes(x=year))+ geom_bar())"
> ggplot(df1,aes(x=year))+geo_bar())
Error: unexpected ')' in "ggplot(df1,aes(x=year))+geo_bar())"
> #bar chart
  > 
  > ggplot(df1,aes(x=year))+geo_bar())
Error: unexpected ')' in "ggplot(df1,aes(x=year))+geo_bar())"
> ggplot(df1,aes(x=year, y=film))+geo_bar())   
Error: unexpected ')' in "ggplot(df1,aes(x=year, y=film))+geo_bar())"
> 